...
public class HarvestFragment extends Fragment {
    private ImageView photoBG,join;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        join = (ImageView) rootView.findViewById(R.id.join);

        //避免OOM 設定背景
        Bitmap bitmap = BitmapUtils.getFitSampleBitmap(getActivity().getApplicationContext(),R.drawable.signin, photoBG.getWidth(), photoBG.getHeight());
        bmpDrawImg = new BitmapDrawable(getResources(),bitmap);
        photoBG.setBackground(bmpDrawImg);
