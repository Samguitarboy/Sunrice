...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            groupHolder.tv_group_icon = (ImageView) convertView.findViewById(R.id.group_name);
            convertView.setTag(groupHolder);
        }else{
            groupHolder = (ViewHolderGroup) convertView.getTag();
        }
        groupHolder.tv_group_icon.setImageResource(gData.get(groupPosition).getgId());
        return convertView;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        //Typeface myTypeface = Typeface.createFromAsset(this.getActivity().getAssets(),"DFT_YUF3.TTC");
        ...
        if(convertView == null){
            ...
            itemHolder.tv_name = (TextView) convertView.findViewById(R.id.item_name);
            //itemHolder.tv_name.setTypeface(myTypeface);
